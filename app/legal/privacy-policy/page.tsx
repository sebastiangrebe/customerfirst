export default function TOS() {
  ...
  <div className="space-y-6">
    <p>
      Your privacy is important to us. It is BetaCustomer&apos;s policy to respect your privacy regarding any information we may
    ...
    <p>
      You can sign up with your Google account so your BetaCustomer&apos;s account username will be prefilled with your name and
    ...
    <p>
      ...
      through BetaCustomer and the services in terms of the applicable data protection laws, including the EU General Data
    ...
    <p className="text-sm text-gray-600 mt-4">This policy is effective as of 7th December 2024.</p>
  </div>
</div>
